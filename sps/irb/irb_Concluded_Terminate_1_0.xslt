																...
																<fo:table-row border="none">
																	...
																	<fo:table-cell border-left="none" border-right="none" border-top="none" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>Concluded - Terminated by PI</xsl:text>
																				</fo:inline>
																			</fo:block>
																		</fo:block-container>
																	</fo:table-cell>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>The project listed has been concluded as of the Principal Investigator signature date on the HSPP form.&#160; IRB File to be archived.</xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
