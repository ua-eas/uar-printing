															...
															<xsl:variable name="altova:tablerows">
																...
																<fo:table-row border="none">
																	...
																	<fo:table-cell border-left="none" border-right="none" border-top="none" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				<fo:inline border="none" font-family="Calibri">
																					<xsl:text>Deferred - Substantive Revisions Required</xsl:text>
																				</fo:inline>
																			</fo:block>
																		</fo:block-container>
																	</fo:table-cell>
										...
										<fo:table-cell number-columns-spanned="2" border="none" border-right="none" padding="2pt" display-align="center">
											<fo:block-container overflow="hidden">
												<fo:block text-align="left">
													...
													<fo:table border="none" table-layout="fixed" width="100%" border-spacing="2pt">
														<fo:table-column column-width="6.630in"/>
																...
																<fo:table-row>
																	<fo:table-cell border="none" border-bottom="none" border-left="none" border-right="none" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				<fo:inline font-family="Calibri">
																					<xsl:text>Please respond to the IRB Committee Comments using the F214: Changes Required to Secure Approval of Human Research no later than one month after the issue date of this letter.&#160; If </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri">
																					<xsl:text>materials are not received by this date, the project will be withdrawn and returned to you.&#160; The PI must include a response to each conditional requirement listed on the F214, attached with this </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri">
																					<xsl:text>letter.&#160; The version date of all revised documents must be updated to match the date on the F214</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri">
																					<xsl:text>and all revisions tracked or highlighted in gray.</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:block>
																					<fo:leader leader-pattern="space"/>
