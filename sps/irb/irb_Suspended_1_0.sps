					...
					<layout-container locksize="1">
						...
						<children>
							...
							<textbox autoresize="1" additional-width="2.94in" additional-height="3.74in">
								<styles height="708px" left="0.20in" overflow="hidden" padding="2px" position="absolute" top="1.60in" width="974px"/>
								<children>
									<tgrid>
										<properties border="1"/>
										<styles border="none"/>
																								...
																								<children>
																									<list>
																										...
																										<children>
																											<listrow>
																												<children>
																													<text fixtext="The attached letter contains Committee&apos;s concerns and reasons for suspension. ">
