																...
																<fo:table-row>
																	<fo:table-cell border="none" border-bottom="none" border-left="none" border-right="none" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				<fo:inline border="none" font-family="Calibri" font-size="12pt">
																					<xsl:text>This submission meets the criteria for exemption under 45 CFR 46.101(b). </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:block>
																					<fo:leader leader-pattern="space"/>
																	...
																	<fo:table-cell border="none" border-right="none" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				...
																				<fo:list-block provisional-distance-between-starts="7mm" provisional-label-separation="2mm">
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>The University of Arizona maintains a Federalwide Assurance with the Office for Human Research Protections (FWA #00004218). </xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>All research procedures should be conducted in full accordance with all applicable sections of the Investigator Manual.</xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>Exempt projects do not have a continuing review requirement.</xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>Amendments to exempt projects that change the nature of the project should be submitted </xsl:text>
																								</fo:inline>
																								<fo:inline font-family="Calibri">
																									<xsl:text>to the Human Subjects Protection Program (HSPP) for a new determination. See the Investigator Manual, &apos;Appendix C Exemptions,&apos; for more information on changes that affect the determination of exemption. Please contact the HSPP to consult on whether the proposed changes need further review.</xsl:text>
																								</fo:inline>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>&#160;</xsl:text>
																								</fo:inline>
																					...
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline font-family="Calibri" font-size="12pt">
																									<xsl:text>All documents referenced in this submission have been reviewed and approved.&#160; Documents are filed with the HSPP Office.&#160; If subjects will be consented the approved consent(s) are attached to the approval notification from the HSPP Office.</xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
																				...
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>Your proposal is in compliance with Federalwide Assurance 00004218. This project should be</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>conducted in full accordance with all applicable sections of the IRB Investigators Manual and you</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>should notify the IRB immediately of any proposed changes that affect the protocol. You should</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>report any unanticipated problems involving risks to the participants or others to the IRB.</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:block>
																					<fo:leader leader-pattern="space"/>
																				...
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>This project has been reviewed and approved by an IRB Chair or designee.</xsl:text>
																				</fo:inline>
																				<fo:block/>
																			</fo:block>
																		</fo:block-container>
