																...
																<fo:table-row>
																	<fo:table-cell border="none" border-bottom="none" border-left="none" border-right="none" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				<fo:inline font-family="Calibri" font-size="12pt" font-weight="bold">
																					<xsl:text>Institution Designated the IRB of Record:</xsl:text>
																				</fo:inline>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>&#160; When an institution is the designated IRB </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>of record, the UA IRB will not review the project.&#160; The University of Arizona agrees that it </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>will rely on the review, approval, and continuing oversight by the institution IRB of </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>those protocols approved by the institution pursuant to the terms of the Institutional</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>Review Board Authorization Agreement (if applicable) and as outlined in the HSPP files.</xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:block>
																					<fo:leader leader-pattern="space"/>
