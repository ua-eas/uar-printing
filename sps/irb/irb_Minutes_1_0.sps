...
<structure version="16" xsltversion="1" html-doctype="HTML4 Transitional" compatibility-view="IE9" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" useimportschema="1" embed-images="1" pastemode="xml" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="irb.xsd" workingxmlfile="C:\Users\krobertson\Desktop\trueSchedule2014-03-3114_59_01.355 (3).xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
...
and ../n1:GuestFlag = &apos;true&apos;" match="n1:AttendentName">
							...
							<template subtype="element" match="n1:Schedule">
								<children>
									<template subtype="element" match="n1:ScheduleMasterData">
										<children>
											<template subtype="element" match="n1:StartTime">
												<children>
													<content subtype="regular">
														<styles font-family="Calibri" font-size="10pt"/>
														<format basic-type="xsd" string="HH:mm AM" datatype="time"/>
													</content>
												</children>
												<variables/>
											</template>
							...
							<template subtype="element" match="n1:Schedule">
								<children>
									<template subtype="element" match="n1:ScheduleMasterData">
										<children>
											<template subtype="element" match="n1:EndTime">
												<children>
													<content subtype="regular">
														<styles font-family="Calibri" font-size="10pt"/>
														<format basic-type="xsd" string="HH:mm AM" datatype="time"/>
															...
															<tgridheader-rows>
																<children>
																	<tgridrow>
																		<children>
																			<tgridcell>
																				<styles border="none" text-align="left"/>
																				<children>
																					<text fixtext="Vote:">
																						<styles font-weight="bold"/>
																					</text>
																	...
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				<styles border="none" text-align="left"/>
																				<children>
																					<template subtype="element" match="n1:YesVote">
																						<children>
																							<content subtype="regular">
																	...
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				<styles border="none" text-align="left"/>
																				<children>
																					<template subtype="element" match="n1:NoVote">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="integer"/>
																							</content>
																	...
																	<tgridrow>
																		<children>
																			<tgridcell>
																				<styles border="none" text-align="left"/>
																				<children>
																					<text fixtext="Abstain:"/>
																				</children>
																			</tgridcell>
																			<tgridcell>
																				<styles border="none" text-align="left"/>
																				<children>
																					<template subtype="element" match="n1:AbstainerCount">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="integer"/>
																							</content>
																	...
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				<styles border="none"/>
																				<children>
																					<template subtype="element" match="n1:VotingComments">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
