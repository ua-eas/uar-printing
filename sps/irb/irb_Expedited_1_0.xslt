													...
													<fo:table border="none" table-layout="fixed" width="100%" border-spacing="2pt">
														...
														<fo:table-body start-indent="0pt">
															<xsl:variable name="altova:tablerows">
																...
																<fo:table-row border-left="none" border-right="none" border-top="none">
																	<fo:table-cell border-left="none" border-right="none" border-top="none" border="solid 1pt gray" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				<fo:inline font-family="Calibri" font-size="12pt" font-weight="bold">
																...
																<fo:table-row>
																	<fo:table-cell border="none" border-bottom="none" border-left="none" border-right="none" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				<fo:inline border="none" font-family="Calibri" font-size="12pt">
																					<xsl:text>This submission meets the criteria for approval under 45 CFR 46.110, 45 CFR 46.111 and/or </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:inline border="none" font-family="Calibri" font-size="12pt">
																					<xsl:text>21 CFR 50 and 21 CFR 56. </xsl:text>
																				</fo:inline>
																				<fo:block/>
																				<fo:block>
																					<fo:leader leader-pattern="space"/>
																	...
																	<fo:table-cell border="none" border-right="none" padding="2pt" display-align="center">
																		<fo:block-container overflow="hidden">
																			<fo:block text-align="left">
																				...
																				<fo:list-block provisional-distance-between-starts="7mm" provisional-label-separation="2mm">
																					...
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>The current consent with the IRB approval stamp must be used to consent subjects.</xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>The Principal Investigator should notify the IRB immediately of any proposed changes that affect the protocol and report any unanticipated problems involving risks to participants or others. </xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
																					<fo:list-item>
																						...
																						<fo:list-item-body start-indent="body-start()">
																							<fo:block>
																								<fo:inline border="none" font-family="Calibri" font-size="12pt">
																									<xsl:text>For projects that wish to continue after the expiration date listed above please submit an F212, Continuing Review Progress Report, forty-five (45) days before the expiration date to ensure timely review of the project.</xsl:text>
																								</fo:inline>
																							</fo:block>
																						</fo:list-item-body>
																					</fo:list-item>
																				...
																				<fo:block/>
																				<fo:inline font-family="Calibri" font-size="12pt">
																					<xsl:text>No changes to a project may be made prior to IRB approval except to eliminate apparent&#160; immediate hazard to subjects.</xsl:text>
																				</fo:inline>
																			</fo:block>
																		</fo:block-container>
																	</fo:table-cell>
