					...
					<layout-container locksize="1">
						...
						<children>
							...
							<textbox autoresize="1" additional-width="2.94in" additional-height="3.74in">
								<styles height="849px" left="0.20in" overflow="hidden" padding="2px" position="absolute" top="1.60in" width="974px"/>
								<children>
									<tgrid>
										<properties border="1"/>
										<styles border="none"/>
																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								<styles border="none"/>
																								<children>
																									<text fixtext="Institution Designated the IRB of Record:">
																										<styles font-family="Calibri" font-size="12pt" font-weight="bold"/>
																									</text>
																									<text fixtext="  When an institution is the designated IRB ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="of record, the UA IRB will not review the project.  The University of Arizona agrees that it ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="will rely on the review, approval, and continuing oversight by the institution IRB of ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="those protocols approved by the institution pursuant to the terms of the Institutional">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="Review Board Authorization Agreement (if applicable) and as outlined in the HSPP files.">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																								</children>
																							</tgridcell>
