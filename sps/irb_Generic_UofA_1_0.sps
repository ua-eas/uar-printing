					...
					<layout-container locksize="1">
						...
						<children>
							...
							<textbox autoresize="1" additional-width="2.94in" additional-height="3.74in">
								<styles height="573px" left="0.20in" overflow="hidden" padding="2px" position="absolute" top="1.60in" width="974px"/>
								<children>
									<tgrid>
										<properties border="1"/>
										<styles border="none"/>
																			...
																			<tgridbody-rows>
																				<children>
																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								<styles border="none" border-bottom="none" border-left="none" border-right="none" text-align="center"/>
																								<children>
																									<text fixtext=" ">
																									...
																									<newline/>
																									<newline/>
																									<text fixtext="This letter is not currently in use.">
																										<styles border="none" font-family="Calibri" font-size="12pt"/>
																									</text>
																								</children>
																							</tgridcell>
