					...
					<layout-container locksize="1">
						...
						<children>
							...
							<textbox autoresize="1" additional-width="2.94in" additional-height="3.74in">
								<styles height="677px" left="0.20in" overflow="hidden" padding="2px" position="absolute" top="1.60in" width="974px"/>
								<children>
									<tgrid>
										<properties border="1"/>
										<styles border="none"/>
																					...
																					<tgridrow>
																						...
																						<children>
																							...
																							<tgridcell>
																								<styles border-left="none" border-right="none" border-top="none"/>
																								<children>
																									<text fixtext="Approved with Conditions - Specific Minor Revisions Required">
																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								...
																								<children>
																									<text fixtext="Please respond to the IRB Committee Comments using the F214: Changes Required to Secure Approval of Human Research no later than one month after the issue date of this letter.  If ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="materials are not received by this date, the project will be withdrawn and returned to you.  The PI must include a response to each conditional requirement listed on the F214, attached with this ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="letter.  The version date of all revised documents must be updated to match the date on the F214">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="and all revisions tracked or highlighted in gray.">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																								</children>
																							</tgridcell>
