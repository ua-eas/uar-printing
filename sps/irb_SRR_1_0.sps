																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								...
																								<children>
																									<text fixtext="Please respond to the IRB Committee Comments using the attached F214: Changes Required to Secure Approval of Human Research no later than one month after the issue date of this letter.  ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="For already approved projects: If materials are not received by this date, the ongoing data ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="collection and analysis will be suspended.  For new projects:  If materials are not received by this date, the project will be withdrawn and returned to you.  The PI must include the text of each comment followed by the response.  The version date of all revised documents must be updated to match the date on the F214 and all revisions tracked or highlighted in gray.">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																								</children>
																							</tgridcell>
