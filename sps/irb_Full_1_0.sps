						...
						<children>
							...
							<textbox autoresize="1" additional-width="5in" additional-height="-0.16in">
								...
								<children>
									<newline/>
									<newline/>
									<text fixtext="This project has been reviewed and approved by the convened IRB.">
																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								...
																								<children>
																									<text fixtext="This submission meets the criteria for approval under 45 CFR 46.111. ">
																										<styles border="none" font-family="Calibri"/>
																									</text>
																								</children>
																							</tgridcell>
																								...
																								<children>
																									<list>
																										...
																										<children>
																											<listrow>
																												<children>
																													<text fixtext="All documents referenced in this submission have been reviewed and approved.  Documents       are filed with the HSPP Office.  If subjects will be consented the approved consent(s) are ">
																														<styles font-family="Calibri" font-size="12pt"/>
																													</text>
																												</children>
																											</listrow>
