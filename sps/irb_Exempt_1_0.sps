					...
					<layout-container locksize="1">
						...
						<children>
							...
							<textbox autoresize="1" additional-width="5in" additional-height="-0.16in">
								<styles height="1.01in" left="0in" overflow="hidden" padding="2px" position="absolute" top="8.37in" width="10.01in"/>
								<children>
									<newline/>
									<newline/>
							...
							<textbox autoresize="1" additional-width="2.94in" additional-height="3.74in">
								<styles height="1132px" left="0.20in" overflow="hidden" padding="2px" position="absolute" top="1.60in" width="974px"/>
								<children>
									<tgrid>
										<properties border="1"/>
										<styles border="none"/>
																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								<styles border="none"/>
																								<children>
																									<text fixtext="This submission meets the criteria for exemption under 45 CFR 46.101(b).">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																								</children>
																							</tgridcell>
																								...
																								<children>
																									<list>
																										...
																										<children>
																											<listrow>
																												<children>
																													<text fixtext="Exempt projects do not have a continuing review requirement.">
																														<styles border="none" font-family="Calibri" font-size="12pt"/>
																													</text>
																												</children>
																											</listrow>
																								...
																								<children>
																									<list>
																										...
																										<children>
																											<listrow>
																												<children>
																													<text fixtext="Amendments to exempt projects that change the nature of the project should be submitted to the Human Subjects Protection Program (HSPP) for a new determination.  See the Investigator Manual, &apos;Appendix C Exemptions,&apos; for more information on changes that affect the determination of exemption.  Please contact the HSPP to consult on whether the proposed changes need further review.">
																														<styles font-family="Calibri" font-size="12pt"/>
																													</text>
																												</children>
																											</listrow>
																									...
																									<newline/>
																									<text fixtext="Your proposal is in compliance with Federalwide Assurance 00004218.  This project should be conducted in full accordance with all applicable sections of the IRB Investigators Manual and you should notify the IRB immediately of any proposed changes that affect the protocol.  You should report any unanticipated problems involving risks to the participants or others to the IRB.">
																										<styles font-family="Calibri"/>
																									</text>
																									<newline/>
																									<newline/>
