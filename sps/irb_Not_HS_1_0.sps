					...
					<layout-container locksize="1">
						...
						<children>
							...
							<textbox autoresize="1" additional-width="5in" additional-height="-0.16in">
								<styles height="-0.16in" left="0in" overflow="hidden" padding="2px" position="absolute" top="8.37in" width="5in"/>
								<children>
									<newline/>
									<newline/>
									<newline/>
							...
							<textbox autoresize="1" additional-width="2.94in" additional-height="3.74in">
								<styles height="1107px" left="0.20in" overflow="hidden" padding="2px" position="absolute" top="1.60in" width="974px"/>
								<children>
									<tgrid>
										<properties border="1"/>
										<styles border="none"/>
																					...
																					<tgridrow>
																						...
																						<children>
																							...
																							<tgridcell>
																								<styles border-bottom-width="thick" border-left="none" border-right="none" border-top="none"/>
																								<children>
																									<text fixtext="Human Subjects Review not Required">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																								</children>
																							</tgridcell>
																	...
																	<tgrid>
																		...
																		<children>
																			<tgridbody-cols>
																				<children>
																					<tgridcol>
																						<styles border="none" width="6.83in"/>
																					</tgridcol>
																				</children>
																			</tgridbody-cols>
																			<tgridbody-rows>
																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								<styles border="none"/>
																								<children>
																									<text fixtext="The project listed above does not require oversight by the University of Arizona because ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="the project does not meet the definition of &apos;research&apos; and/or &apos;human subject&apos;.">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																								</children>
																							</tgridcell>
																								...
																								<children>
																									<list>
																										...
																										<children>
																											<listrow>
																												<children>
																													<text fixtext="Not Research as defined by 45 CFR 46.102(d):">
																														<styles border="none" font-family="Calibri" font-size="12pt" font-weight="bold"/>
																													</text>
																													<text fixtext=" As presented, the activities described ">
																									...
																									<text fixtext="      "/>
																									<text fixtext="above do not meet the definition of research as cited in the regulations issued by the U.S. ">
																										<styles border="none" font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="       ">
																									...
																									<text fixtext="Department of Health and Human Services which state that &quot;research means a systematic   ">
																										<styles border="none" font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="       ">
																									...
																									<text fixtext="investigation, including research development, testing and evaluation, designed to ">
																										<styles border="none" font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="       contribute to generalizable knowledge&quot;.">
																										<styles border="none" font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																								</children>
																								...
																								<children>
																									<list>
																										...
																										<children>
																											<listrow>
																												<children>
																													<text fixtext="Not Human Subjects Research as defined by 45 CFR 46.102(f): ">
																														<styles font-family="Calibri" font-size="12pt" font-weight="bold"/>
																													</text>
																													<text fixtext="As presented, the ">
																														<styles font-family="Calibri" font-size="12pt"/>
																													</text>
																												</children>
																											</listrow>
																									...
																									<text fixtext="       activities described above do not meet the definition of research involving human ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="      "/>
																									<text fixtext="subjects as cited in the regulations issued by the U.S. Department of Health and Human ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="      "/>
																									<text fixtext="Services which state that &quot;human subject means a living individual about whom an ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="      "/>
																									<text fixtext="investigator (whether professional or student) conducting research obtains data through   ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="      "/>
																									<text fixtext="intervention ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<text fixtext="or">
																										<styles font-family="Calibri" font-size="12pt" font-style="italic" font-weight="bold"/>
																									</text>
																									<text fixtext=" interaction with the individual, or identifiable private information&quot;.">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																								</children>
																					...
																					<tgridrow>
																						<children>
																							<tgridcell>
																								<styles border="none" border-right="none"/>
																								<children>
																									<text fixtext="Note: Modifications to projects not requiring human subjects review that change the nature ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="of the project should be submitted to the Human Subjects Protection Program (HSPP) for a new determination (e.g. addition of research with children, specimen collection, participant ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="observation, prospective collection of data when the study was previously retrospective in ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="nature, and broadening the scope or nature of the research question).  Please contact the ">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<text fixtext="HSPP to consult on whether the proposed changes need further review.">
																										<styles font-family="Calibri" font-size="12pt"/>
																									</text>
																									<newline/>
																									<newline/>
																									<text fixtext="The University of Arizona maintai">
																										<styles border="none" font-family="Calibri" font-size="12pt"/>
																									</text>
																									<text fixtext="ns a Federalwide Assurance with the Office for Human ">
																										<styles border="none" font-family="Calibri"/>
																									</text>
																									<newline/>
																									<text fixtext="Research Protections (FWA #00004218)">
																										<styles border="none" font-family="Calibri"/>
																									</text>
																									<text fixtext=".">
																										<styles font-family="Calibri"/>
